...
public class Engine {
    ...
    private void loadClasses() throws ClassNotFoundException, NoSuchMethodException {
        ...
        cJavaParam = Class.forName("com.bluekelp.fiji.core.JavaParam");
        cVariable = Class.forName("com.bluekelp.fiji.core.Variable");
        cValue = Class.forName("com.bluekelp.fiji.core.Value");
        cDefinition = Class.forName("com.bluekelp.fiji.core.Definition");
        cParameterizedPrimitive = Class.forName("com.bluekelp.fiji.core.ParameterizedPrimitive");
